...
const HomeCards = () => {
  return (
    ...
    >
      ...
      <div className="w-full h-30 absolute z-1 top-40 bg-[linear-gradient(180deg,#333333_0%,rgba(51,51,51,0.966838)_16.94%,rgba(51,51,51,0.792051)_35.41%,rgba(51,51,51,0)_90.36%)]" />
          ...
          >
            ...
            <div className="text-white lg:absolute lg:bottom-0 lg:left-0 my-10 mx-13 lg:mx-15 lg:my-15 z-4">
              ...
              <p className="text-base lg:text-3xl font-normal leading-tight">
                We design state of the art websites and applications keeping the
                User Experience and User Interface in mind. Our designing
          ...
          >
            ...
            <div className="text-white lg:absolute lg:bottom-0 lg:left-0 my-10 mx-13 lg:mx-15 lg:my-15 z-4">
              ...
              <p className="text-base lg:text-3xl font-normal leading-tight">
                ...
                country. All coding departments will give you the opportunity to
                interact and learn from experienced developers.
              </p>
            </div>
          </div>
          <Image
          ...
          >
            ...
            <div className="text-white lg:absolute lg:bottom-0 lg:left-0 my-10 mx-13 lg:mx-15 lg:my-15 z-4">
              ...
              <p className="text-base lg:text-3xl font-normal leading-tight">
                ...
                with the best environment for learning and teaching development
                skills.
              </p>
            </div>
          </div>
